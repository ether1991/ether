...
if ( ! function_exists( 'hacker_entry_taxonomies' ) ) :
/**
 ...
 * Posts Navigation
 */
function hacker_posts_navigation() {

?>
<nav class="Pagination">
	<?php
		previous_posts_link( __('&larr;Newer', 'hacker') );
		next_posts_link( __('Older&rarr;', 'hacker') );
	?> 
</nav>
<!-- END .Pagination -->
<?php
...
function hacker_password_form() {
    ...
    <div class="form-group"><label for="' . $label . '">' . __( "Password:", "hacker" ) . ' </label><input name="post_password" id="' . $label . '" type="password" size="20" maxlength="20" /></div><div class="form-group"><input type="submit" name="Submit" class="form-control" value="' . esc_attr__( "Submit", "hacker" ) . '" /></div>
    </form>
    ';
    return $o;
}
